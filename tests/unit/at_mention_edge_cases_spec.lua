-- このファイルはCodex.nvimの@メンション送信における境界ケースを検証します。
...
describe("At Mention Edge Cases", function()
  ...
  describe("add_paths_to_codex error scenarios", function()
    it("should handle empty file list", function()
      ...
      local success_count, total_count = init_module._add_paths_to_codex({})
    ...
    it("should handle nil file list", function()
      ...
      local success_count, total_count = init_module._add_paths_to_codex(nil)
      expect(success_count).to_be(0)
      expect(total_count).to_be(0)
    end)
    ...
    it("should handle mixed success and failure", function()
      ...
      local success_count, total_count = init_module._add_paths_to_codex(files, { show_summary = false })
    ...
    it("should provide user notifications for mixed results", function()
      ...
      local success_count, total_count = init_module._add_paths_to_codex(files, { show_summary = true })
